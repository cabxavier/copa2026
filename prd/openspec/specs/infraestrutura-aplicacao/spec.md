...
Define a estrutura da solução Blazor Web App do PortalCopa26 em projeto único, a organização de pastas preparada para futura migração em camadas e a configuração da injeção de dependência nativa do ASP.NET Core.
