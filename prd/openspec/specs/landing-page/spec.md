...
Define a página inicial (Landing Page) do PortalCopa26: composta por componentes Blazor reutilizáveis (hero com logo e países-sede, estatísticas do torneio, próximos jogos, gráfico do Ranking FIFA com Chart.js e painel/CTA do simulador), alimentada por serviços de dados (sem EF Core nos componentes), com navegação interna por âncoras e recursos visuais (logo e bandeiras) servidos localmente.
